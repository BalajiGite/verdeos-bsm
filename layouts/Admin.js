            ...
            <div className="mx-14 mt-5 background-color-linear p-4 border rounded border-[#8E8E8E] relative">
              ...
              <div className=" justify-between grid grid-cols-2 gap-x-1 mt-1">
                <div className="border-r  border-[#8E8E8E] px-3">
                  <p className="text-xl font-semibold text-[#C5C5C5] mb-0 ">Actionable Insights Summary</p>
                ...
                <div className=" bg-[#0A1016] py-1 border border-[#8E8E8E] rounded">
                  ...
                  <div className="flex px-4 mt-1 justify-between ">
                    <div className="flex items-center px-2 border-r border-[#8E8E8E]">
                    ...
                    <div className="flex items-center  border-r border-[#8E8E8E] px-2">
              ...
              <div className="mt-1 grid grid-cols-2 gap-x-1 ">
                <div className="border border-[#8E8E8E] rounded bg-[#0A1016]">
                  ...
                  <div className="flex justify-between">
                    <div className="flex items-center px-1 border-r py-1 border-[#8E8E8E]">
                    ...
                    <div className="flex items-center  border-r border-[#8E8E8E] px-1">
